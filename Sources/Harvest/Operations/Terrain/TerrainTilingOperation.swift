...
internal class TerrainTilingOperation: ConcurrentOperation,
                                       ConsumesResult {
    
    public var input: Result<TerrainKiteRenderOperation.Prefabs, Error> = Result { throw ResultError.noResult }
